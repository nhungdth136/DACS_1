    ...
    public void loadThongTin(String tenPhong, KhachHang kh, int soNguoi, LocalDate ngayTra) throws IOException, SQLException {
        ...
        if (ngayTra != null) {
            ...
            if (!txt_ngayTra.getDate().toString().equals("")) {
                ...
                Phong p = p_dao.getPhongTheoTenPhong(txt_tenPhong.getText()).get(0);
                LocalDate ngayThue = txt_ngayThue.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate();
                cthd.setNgayNhanPhong(ngayThue);
                cthd.setNgayTraPhong(ngayTra);
                cthd.setPhong(phong);
...
//                        System.out.println("Ngay Tra: " + ngayTra);
                    ...
                    if (!maKhachHang.isEmpty()) {
                        ...
                        if (!khachHangList.isEmpty()) {
                            ...
                            if (kh.isTrangThaiKhachHang()) {
                                ...
                                JOptionPane.showMessageDialog(null, "Khách hàng này đang nằm trong danh sách đen!");
                                txt_HvT.setText(kh.getHoTenKhachHang());
                                txt_CCCD.setText(kh.getCCCD());
                                if (kh.isGioiTinh()) {
                                    rd_nam.setSelected(true);
    ...
    public void genID_HD(HoaDon hd) {
        ...
        int soLuong = hd_dao.demSoLuongHoaDonTheoMaMau("HD" + sdf.format(cal.getTime()));
        System.out.println("gui.JPanel_thuePhong.genID_HD()" + "HD" + sdf.format(cal.getTime()));
        System.out.println("gui.JPanel_thuePhong.genID_HD()" + "HD" + soLuong);
        String sl = String.format("%03d", soLuong);
        String maHD = "HD" + sdf.format(cal.getTime()) + sl;
        System.out.println("gui.JPanel_thuePhong.genID_HD()" + "HD" + maHD);
        hd.setMaHoaDon(maHD);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource().equals(btn_xoa)) {
            ...
            if (selectedRow != -1) {
                DoAnUong dau = null;
                try {
                    dau = dau_dao.getPhongTheoTenDoAnUong(modelDichVu.getValueAt(selectedRow, 0).toString()).getFirst();
                    dau.setGiaBan();
        ...
        if (e.getSource().equals(btn_Luu)) {
            if (!txt_SDT.getText().equals("") && !txt_HvT.getText().equals("") && !txt_ngayTra.equals("") && !txt_ngayThue.equals("") && cbSoNguoi.getSelectedIndex() != -1) {
                if (!txt_ngayTra.getDate().before(txt_ngayThue.getDate())) {
                    Phong p = null;
                    HoaDon hd = new HoaDon();
                    genID_HD(hd);
                ...
                JOptionPane.showMessageDialog(this, "Không được để trống ngày thuê/trả, số người ở, SĐT khách hàng");
            }
        }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(77, 134, 156), 2, true));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_xoa, javax.swing.GroupLayout.DEFAULT_SIZE, 157, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_xoa, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_ngayTra, javax.swing.GroupLayout.DEFAULT_SIZE, 531, Short.MAX_VALUE)
        ...
        btn_themKH.setIcon(new FlatSVGIcon(getClass().getResource("/icon/search_1.svg")));
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addComponent(txt_SDT, javax.swing.GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tbl_gioDichVu.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel10.setBackground(new java.awt.Color(205, 232, 229));
        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Thông Tin Hóa Đơn", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 3, 12), new java.awt.Color(77, 134, 156))); // NOI18N
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_tienDV, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE)
